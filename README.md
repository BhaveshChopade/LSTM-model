...
- Add a clear model artifact pipeline (`train -> save -> load -> infer`).
- Add input validation for test index boundaries.
- Add minimal logging and exception handling around file/model loads.
- Add unit tests for preprocessing and integration tests for login + DB behavior.
...
No explicit license file is currently present. If this repository is to be shared publicly, add a license (e.g., MIT, Apache-2.0) and contribution guidelines.
